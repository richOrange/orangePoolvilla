...
<html lang="en">
  <head>
    ...
    <title>Orange-poolvilla:updatePoolvilla</title>
  ...
  <section class="probootstrap-section">
    <div class="container">
		<h2>update poolvilla info</h2>
		<br>
        <!-- Form -->
        <form action="${pageContext.request.contextPath}/host/updatePoolvillaOneController" method="post" class="probootstrap-form mb60" id="updateForm">
           	<table class = "table table-active">
				<tr>
					<td>판매자</td>
					<td><input type="text" name="hostId" id="hostId" class="form-control" value="${ selectPoolvillaOne.hostId }" readonly="readonly"></td>
				</tr>
				<tr>
					<td>지역</td>
					<td>
						<select id="locationNo" name="locationNo" class="form-control">
	                     	<option value="-1">:: 지역 선택 ::</option>
		                      <c:forEach var ="m" items="${ locationList }">
		                      	<c:if test="${ m.locationName == selectPoolvillaOne.locationName }">
				...
				<tr>
					<td>상세 주소</td>
					<td>
						<input type="text" name="pvDetailaddr" id ="pvDetailaddr" class="form-control" placeholder="Please enter the detail address" value="${ selectPoolvillaOne.pvDetailaddr }">
						&nbsp; 
				...
				<tr>
					<td>풀빌라 이름</td>
					<td>
						<input type="text" name="pvName" id ="pvName" value="${ selectPoolvillaOne.pvName }" class="form-control" placeholder="Please enter the poolvilla name">
						&nbsp; 
				...
				<tr>
					<td>가격</td>
					<td>
						<input type="text" name="price" id ="price" value="${ selectPoolvillaOne.price }" class="form-control" placeholder="Please enter the price">
						&nbsp; 
				...
				<tr>
					<td>면적</td>
					<td>
						<input type="text" name="pvSize" id ="pvSize" value="${ selectPoolvillaOne.pvSize }" class="form-control" placeholder="Please enter the size">
						&nbsp; 
				...
				<tr>
					<td>층수</td>
					<td>
						<input type="text" name="pvFloor" id ="pvFloor" value="${ selectPoolvillaOne.pvFloor }"  class="form-control" placeholder="Please enter the floor">
						&nbsp; 
				...
				<tr>
					<td>최대 인원</td>
					<td>
						<input type="text" name="pvPeople" id ="pvPeople" value="${ selectPoolvillaOne.pvPeople }" class="form-control" placeholder="Please enter the people number">
						&nbsp; 
