...
<head>
    ...
    <!-- Title -->
    <title>OrangePoolvilla : poolvillaLocation</title>
                ...
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <div class="breadcrumb-post-content">
                            <h2 class="post-title">poolvillaLocation List</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
									...
									<tbody>
										<tr>
											<c:forEach var = "pl" items = "${list }">
												<tr>
													<td>${pl.getLocationNo()}</td>
													<td>${pl.getLocationName()}</td>
													<td>${pl.getUpdateDate()}<td> 
													<td><a href="${pageContext.request.contextPath}/host/deletePoolvillaLocationController?locationNo=${ pl.getLocationNo()}" class = "btn btn-outline-secondary btn-sm">삭제</a></td>
												</tr>
											</c:forEach>
										</tr>
									</tbody>
                    ...
                    <div class="roberto-contact-form mt-80 mb-100">
                        ...
                        <!-- Form -->
                        <form action="${pageContext.request.contextPath}/host/poolvillaLocationController" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <input type="text" name="locationName" class="form-control mb-30" placeholder="Please enter location">
                                </div>
                                <div class="col-12">
