                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="post-thumbnail">
                            <a href="${pageContext.request.contextPath}/template/#"><img src="${pageContext.request.contextPath}/template/img/bg-img/24.jpg" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                            <div class="post-meta">
                                <a href="${pageContext.request.contextPath}/template/#" class="post-author">Jan 02, 2019</a>
                                <a href="${pageContext.request.contextPath}/template/#" class="post-tutorial">Event</a>
                            </div>
                            <!-- Post Title -->
                            <a href="${pageContext.request.contextPath}/template/#" class="post-title">Cdc Issues Health Alert Notice For Travelers To Usa From Hon</a>
                            ...
                            <a href="${pageContext.request.contextPath}/template/#" class="btn continue-btn">Read More</a>
                        </div>
                    </div>
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="200ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="${pageContext.request.contextPath}/template/#"><img src="${pageContext.request.contextPath}/template/img/bg-img/25.jpg" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                            <div class="post-meta">
                                <a href="${pageContext.request.contextPath}/template/#" class="post-author">Jan 04, 2019</a>
                                <a href="${pageContext.request.contextPath}/template/#" class="post-tutorial">Event</a>
                            </div>
                            <!-- Post Title -->
                            <a href="${pageContext.request.contextPath}/template/#" class="post-title">How To Boost Your Traffic Of Your Blog And Destroy The Competition</a>
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="${pageContext.request.contextPath}/template/#"><img src="${pageContext.request.contextPath}/template/img/bg-img/26.jpg" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                            <div class="post-meta">
                                <a href="${pageContext.request.contextPath}/template/#" class="post-author">Jan 09, 2019</a>
                                <a href="${pageContext.request.contextPath}/template/#" class="post-tutorial">Event</a>
                            </div>
                            <!-- Post Title -->
                            <a href="${pageContext.request.contextPath}/template/#" class="post-title">Global Travel And Vacations Luxury Travel On A Tight Budget</a>
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="400ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="${pageContext.request.contextPath}/template/#"><img src="${pageContext.request.contextPath}/template/img/bg-img/27.jpg" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                            <div class="post-meta">
                                <a href="${pageContext.request.contextPath}/template/#" class="post-author">Jan 22, 2019</a>
                                <a href="${pageContext.request.contextPath}/template/#" class="post-tutorial">Event</a>
                            </div>
                            <!-- Post Title -->
                            <a href="${pageContext.request.contextPath}/template/#" class="post-title">Will The Democrats Be Able To Reverse The Online Gambling Ban</a>
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="${pageContext.request.contextPath}/template/#"><img src="${pageContext.request.contextPath}/template/img/bg-img/28.jpg" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                            ...
                            <!-- Post Title -->
                            <a href="${pageContext.request.contextPath}/template/#" class="post-title">Les Houches The Hidden Gem Of The Chamonix Valley</a>
